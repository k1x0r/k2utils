...
//
//===----------------------------------------------------------------------===//
/// 🚨🚨🚨🚨 Ok, this should do encoding/decoding from/to internal Swift collections like Dictionary/Array etc...
...
fileprivate class _PlistEncoder : Encoder {
    ...
    fileprivate let options: CollectionEncoder._Options
    ...
    fileprivate init(options: CollectionEncoder._Options, codingPath: [CodingKey] = []) {
...
fileprivate class _PlistDecoder : Decoder {
    ...
    fileprivate let options: CollectionDecoder._Options
    ...
    fileprivate init(referencing container: Any, at codingPath: [CodingKey] = [], options: CollectionDecoder._Options) {
